...
export const LIFI_TOKENS_BASE_URL = 'https://li.quest/v1/tokens' as const;
export const LIFI_TOKEN_BASE_URL = 'https://li.quest/v1/token' as const;
...
export const SUPPORTED_CHAINS: IChain[] = [
	...
	},
	{
		...
		metamask: {
			...
			rpcUrls: ['https://rpc.api.moonbeam.network', 'https://moonbeam-rpc.publicnode.com', 'https://moonbeam.drpc.org']
		},
		nativeToken: {
			address: '0x0000000000000000000000000000000000000000',
			chainId: 1284,
	...
	},
	{
		...
		metamask: {
			chainId: '0x868b',
			blockExplorerUrls: ['https://explorer.mode.network/', 'https://modescan.io/'],
			chainName: 'Mode',
			nativeCurrency: {
				name: 'ETH',
				symbol: 'ETH',
	...
	},
	{
		...
		metamask: {
			...
			rpcUrls: ['https://forno.celo.org', 'https://celo.drpc.org', 'https://rpc.ankr.com/celo']
		},
		nativeToken: {
	...
	},
	{
		...
		metamask: {
			chainId: '0x1388',
			blockExplorerUrls: ['https://explorer.mantle.xyz/', 'https://mantlescan.xyz/'],
			chainName: 'Mantle',
			nativeCurrency: {
				name: 'Mantle',
				symbol: 'MNT',
	...
	},
	{
		...
		metamask: {
			...
			rpcUrls: ['https://evmos.lava.build', 'https://evmos-evm-rpc.publicnode.com', 'https://evmos.drpc.org']
		},
		nativeToken: {
			address: '0x0000000000000000000000000000000000000000',
			chainId: 9001,
...
export const SUPPORTED_CHAINS_FOR_DROPDOWNS = SUPPORTED_CHAINS.map(sC => ({
	value: sC.id,
	label: sC.name
}));
